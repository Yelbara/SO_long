...
static void	destroy_image(t_point *list)
{
	...
	mlx_destroy_image(list->data.mlx_ptr, list->data.img.collectibles[0]);
	mlx_destroy_image(list->data.mlx_ptr, list->data.img.collectibles[1]);
	mlx_destroy_image(list->data.mlx_ptr, list->data.img.enemy);
}
